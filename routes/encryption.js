...
router.post("/decryptResponse", async (req, res) => {
...
router.post("/decryptId", async (req, res) => {
    console.log(req.body);
    const { data } = req.body;
...
router.post("/encryptPayload", async (req, res) => {
    console.log(req.body);
    const resp = await encryptPayload(req.body);
    res.status(200).json(resp);
});

router.post("/encryptId", async (req, res) => {
    console.log(req.body);
    const { data } = req.body;
    const resp = await encryptURLParam(data);
    res.status(200).json(resp);
});
